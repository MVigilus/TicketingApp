...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    if (this.authService.currentUserValue) {
      ...
      this.userType = "Operatore";
      console.log("ISADMIN : "+this.authService.currentUserValue.admin)
      this.sidebarItems = (!this.authService.currentUserValue.admin)?ROUTES.filter((sidebarItem) => sidebarItem):ROUTESADMIN.filter((sidebarItem)=> sidebarItem);
    }
